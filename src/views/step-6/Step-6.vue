<template>
  <div>
    ...
    <video id="step-6" class="step-video" width="1280" height="720" autoplay preload loop disablePictureInPicture >
...
<script lang="js" src="./Step-6.js"></script>
<style lang="scss" src="./Step-6.scss" ></style>